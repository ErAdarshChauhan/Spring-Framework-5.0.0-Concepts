...
public class ClientApplication {
	...
	public static void main(String[] args) {
		...
		ApplicationContext container = new ClassPathXmlApplicationContext("spring_cfg_constructor_injection_using_different_types_of_bean_properties.xml","spring_cfg_constructor_injection_using_different_types_of_bean_properties2.xml");
