package org.mindgame.sf_core_constructor_injection;
...
public class ClientApplication {
	...
	public static void main(String[] args) {
		...
		ApplicationContext container = new ClassPathXmlApplicationContext("spring_cfg_constructor_injection.xml");
